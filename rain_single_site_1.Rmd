...
```{r duration_analysis-part-1, eval=FALSE, echo = FALSE,message=FALSE, warning=FALSE}
...
# the read function was removed becuase the 5-minute rainfall data was already read in a previous chunk
    ...
    for (i in seq_along(MIT_value)) {
      ...
      # create a file name to save the files for each site
      # CSV_file_name<-paste0(site_prefix,"_Gap_Times_All","_MIT_",MIT_value[i],".csv")
...
```{r testing-basic-stats, eval= TRUE, echo = FALSE,include = TRUE, message=FALSE, warning=FALSE, results = 'asis',fig.width=14,fig.height=10}
