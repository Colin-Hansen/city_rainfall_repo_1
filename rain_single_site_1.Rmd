...
# the read function was removed becuase the 5-minute rainfall data was already read in a previous chunk
    ...
    for (i in seq_along(MIT_value)) {
      ...
      CSV_file_name<-paste0(site_prefix,"_Stats_Gap Times","_MIT_",MIT_value[i],".csv")
      CSV_outfile<-file.path(stats_folder_4, CSV_file_name)
      ...
      # create a file name to save the file for each site
      # CSV_file_name<-paste0(site_prefix,"_Duration_",duration_value[i],"_Rain_Events_Last_Line","_MIT_",MIT_value[i],".csv")
      ...
      # create a file name to save the file for each site
      CSV_file_name<-paste0(site_prefix,"_Stats_Summary_All_Events","_MIT_",MIT_value[i],".csv")
      CSV_outfile<-file.path(stats_folder_4, CSV_file_name)
      ...
      CSV_file_name<-paste0(site_prefix,"_Rain_Events_Duration_",duration_value[i],"_MIT_",MIT_value[i],".csv")
      CSV_outfile<-file.path(out_folder_dynamic, CSV_file_name)
      ...
      # create a file name to save the file for each site
      CSV_file_name<-paste0(site_prefix,"_Stats_Summary_Duration_",duration_value[i],"_MIT_",MIT_value[i],".csv")
      CSV_outfile<-file.path(out_folder_dynamic, CSV_file_name)
      ...
      CSV_file_name<-paste0(site_prefix,"_Duration_",duration_value[i],"_Events_Plus_Minus_","_MIT_",MIT_value[i],".csv")
      #CSV_outfile<-file.path(out_folder_events_full, CSV_file_name)
      CSV_outfile<-file.path(out_folder_dynamic, CSV_file_name)
      ...
      # CSV_file_name<-paste0(site_prefix,"_Duration_",duration_value[i],"_RainEvents_by_depth_with_Chicago","_MIT_",MIT_value[i],".csv")
      # CSV_outfile<-file.path(out_folder_dynamic, CSV_file_name)
      ...
      # create chart title (dynamic)
      chart_title<-paste0(site_prefix," ",duration_value[i]," +/- 10%: Top 5 versus Chicago DS_","_MIT_",MIT_value[i])
      
      # create chart PNG outfile (dynamic)
      outfile_name<-paste0(site_prefix," ",duration_value[i],"_Minute Events Top 5 versus Chicago DS_","_MIT_",MIT_value[i],".png")
      ...
      # create chart title (dynamic)
      chart_title<-paste0(site_prefix," ",duration_value[i]," +/- 10%: All Events versus Chicago DS_","_MIT_",MIT_value[i])
      
      # create chart PNG outfile (dynamic)
      outfile_name<-paste0(site_prefix," ",duration_value[i],"_Minute Events versus Chicago DS_","_MIT_",MIT_value[i],".png")
