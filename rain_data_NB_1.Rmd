...
```{r summary statistics, echo = FALSE,include = TRUE}
  ...
  # seq along the .CSV files; generate basic summary stastics
    ...
    # print(csv_names)
     ...
     for (i in seq_along(csv_names)) {
      ...
      # with 'stats_5_min_compiled': save .csv file and plot bar chart of data count all sites
      ...
      temp_name<-paste0(dir_3,"/stats_5_min_all_sites.csv")
  ...
  stats_table<-read.table('data_out/Stats_Summary_3/stats_5_min_all_sites.csv',sep=",",header=TRUE,stringsAsFactors = FALSE)
