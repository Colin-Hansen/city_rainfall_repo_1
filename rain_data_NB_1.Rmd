...
```{r summary statistics,include=FALSE}
  ...
  rain_stats_function_1 <- function(files) {
      ...
      ## OLD: using 'summarytools' package
      ...
      # convert summarytools objects to tibble; transpose the result
      # stats_summary <- t(tb(stats_summary,drop.var.col = FALSE))
      ...
      # colnames(stats_5_min) <- c("Statistic","Value")
      
      
      # print(class(stats_5_min))
